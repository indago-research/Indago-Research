...
nltk_data_path = './nltk_data'  # Path to the parent folder of 'tokenizers'
...
def limit_response_length(response):
    ...
    sentences = english_tokenizer.tokenize(response)  # Use custom tokenizer # Splitting into sentences
